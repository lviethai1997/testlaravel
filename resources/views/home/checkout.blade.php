                        ...
                        <div id="collapseOne" class="accordion-body collapse in">
                            <div class="accordion-inner">
                                <div class="span6 check-method-left"> <strong class="green-t">Checkout as a Guest or Register</strong>
                                    ...
                                    <label class="radio">
                                        <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked=""> Checkout as Guest </label>
                                    <label class="radio">
                                        <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2"> Register </label>
                                    <p>Register and save time!</p>
                                    <p>Register with us for future convenience:</p>
                                    <p>* Fast and easy check out
                                        <br> * Easy access to your order history and status</p>
                                ...
                                <div class="span5 check-method-right"> <strong class="green-t">Login</strong>
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="password" id="inputPassword" placeholder="" style="display: none;">
                                        ...
                                        <li>
                                            <div class="control-group">
                                                ...
                                                <label class="radio b-label">
                                                    <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked=""> Ship to this address
                                                </label>
                                                <label class="radio b-label">
                                                    <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2"> different address
                                                </label>
                                            </div>
                                            <div class="control-group">
