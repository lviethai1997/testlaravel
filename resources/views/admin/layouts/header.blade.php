			...
			<div id="navbar-container" class="boxed">
				...
				<div class="navbar-header">
					<a href="{{ route('admin.index') }}" class="navbar-brand">
						<img src="assets/admin/img/logo.png" alt="Nifty Logo" class="brand-icon">
									...
									<div class="nano-content">
										<ul class="head-list">
											...
											<li>
												<a href="#" class="media">
													<div class="media-left">
														<img src="assets/admin/img/av2.png" alt="Profile Picture" class="img-circle img-sm">
													</div>
											...
											<li>
												<a href="#" class="media">
													<div class="media-left">
														<img src="assets/admin/img/av4.png" alt="Profile Picture" class="img-circle img-sm">
													</div>
													<div class="media-body">
											...
											<li>
												<a href="#" class="media">
													<div class="media-left">
														<img src="assets/admin/img/av3.png" alt="Profile Picture" class="img-circle img-sm">
													</div>
													<div class="media-body">
											...
											<li>
												<a href="#" class="media">
													<div class="media-left">
														<img src="assets/admin/img/av6.png" alt="Profile Picture" class="img-circle img-sm">
													</div>
													<div class="media-body">
						...
						<li class="dropdown">
							<a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown">
								<span class="lang-selected">
									<img class="lang-flag" src="assets/admin/img/flags/united-kingdom.png" alt="English">
							...
							<ul class="head-list dropdown-menu with-arrow">
								...
								<li>
									<!--France-->
									<a href="#">
										<img class="lang-flag" src="assets/admin/img/flags/france.png" alt="France">
								...
								<li>
									<!--Germany-->
									<a href="#">
										<img class="lang-flag" src="assets/admin/img/flags/germany.png" alt="Germany">
								...
								<li>
									<!--Italy-->
									<a href="#">
										<img class="lang-flag" src="assets/admin/img/flags/italy.png" alt="Italy">
								...
								<li>
									<!--Spain-->
									<a href="#">
										<img class="lang-flag" src="assets/admin/img/flags/spain.png" alt="Spain">
						...
						<li id="dropdown-user" class="dropdown">
							<a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
								<span class="pull-right">
									<img class="img-circle img-user media-object" src="assets/admin/img/av1.png" alt="Profile Picture">
								</span>
