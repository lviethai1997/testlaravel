            ...
            @method('PUT')
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" required value="{{ $product->name }}"  name="name" placeholder="Nhập tên sản phẩm" class="form-control input-sm" id="demo-is-inputsmall">
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" required  name="price_input" value="{{ $product->price_input }}" placeholder="Nhập giá mua" class="form-control" id="demo-is-inputnormal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" required  name="price" value="{{ $product->price }}" placeholder="Nhập giá bán" class="form-control" id="demo-is-inputnormal">
                            @if ($errors->has('price'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" required  name="sale" value="{{ $product->sale }}" placeholder="Nhập giảm giá" class="form-control" id="demo-is-inputnormal">
                            @if ($errors->has('sale'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <img id="image" src="{{asset('img/upload/product')}}{{ '/'.$product->thunbar }}" width="200" height="200">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                        <textarea rows="4" cols="50" required  class="form-control" name="description" class="form-control input-sm" id="demo-is-inputsmall">{{ $product->description }}</textarea>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-9 col-sm-offset-3" style="padding-top:10px">
                            ...
                            <button onclick="location.href='{{ route('product.index') }}'" class="btn btn-danger btn-labeled fa fa-repeat fa-lg" type="reset">Hủy Bỏ</button>
                        </div>
                    </div>
                </div>
            </form>
