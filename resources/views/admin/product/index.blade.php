                    ...
                    <table id="demo-dt-basic" class="table table-striped table-bordered dataTable no-footer dtr-inline collapsed" cellspacing="0" width="100%" role="grid" aria-describedby="demo-dt-basic_info" style="width: 100%;">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="min-tablet sorting" tabindex="0" aria-controls="demo-dt-basic" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 100px;">Category</th>
                                ...
                                <th class="min-tablet sorting" tabindex="0" aria-controls="demo-dt-basic" rowspan="1" colspan="1" aria-label="Extn.: activate to sort column ascending" style="width: 50px;">View</th>
                        ...
                        @foreach ($product as $products)
                            <tr>
                                <td style="text-align:center;font-weight:bold;font-size:16px">{{ $products->name }}</td>
                                <th style="text-align:center;font-weight:bold;font-size:16px">{{ isset($products->category->cate_name) ? $products->category->cate_name : '[N\A]'}}</th>
                                <td style="text-align:center;font-weight:bold;font-size:16px">{{ $products->slug }}</td>
                                <td style="text-align:center;font-weight:bold;font-size:16px">{{ $products->price }}</td>
                                <td style="text-align:center;font-weight:bold;font-size:16px"><img src="{{asset('img/upload/product')}}{{ '/'.$products->thunbar }}" witdh="100px" height="100px" class="css-class" alt="alt text"></td>
                                <td>{{ $products->view }}</td>
